...
const Navigator = () => {
  ...
  return (
    <div className='fixed top-[90vh]'>
      <div className="hover:scale-x-105 transition-all duration-300 *:transition-all *:duration-300 flex justify-start text-2xl items-center gap-6 shadow-xl z-10 bg-[#e8e4df] p-2 rounded-full">
